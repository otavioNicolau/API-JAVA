...
class PdfProcessingServiceImplTest {
  ...
  void setUp() {
    ...
    pdfProcessingService = new PdfProcessingServiceImpl(storageService);
  ...
  void shouldValidateOptionsForMergeOperation() {
    ...
    assertTrue(
        pdfProcessingService.validateOptions(
            JobOperation.MERGE, invalidOptions)); // MERGE aceita qualquer opção
  }
  ...
  void shouldValidateOptionsForSplitOperation() {
    ...
    assertTrue(
        pdfProcessingService.validateOptions(
            JobOperation.SPLIT, emptyOptions)); // Split sem páginas específicas é válido
  }
  ...
  void shouldReturnOptionsSchemaForOperations() {
    ...
    Map<String, Object> watermarkSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.WATERMARK);
    ...
    Map<String, Object> pdfToImagesSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_TO_IMAGES);
    ...
    Map<String, Object> imagesToPdfSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.IMAGES_TO_PDF);
  ...
  void shouldThrowExceptionForNonExistentInputFiles() {
    // Given
    Job jobWithNonExistentFiles =
        new Job(
            "job-999",
            JobOperation.MERGE,
            List.of("non-existent1.pdf", "non-existent2.pdf"),
            Map.of());
  ...
  void shouldValidateOptionsForPdfCompareOperation() {
    // Given
    Map<String, Object> validOptions =
        Map.of("detailed_diff", true, "output_filename", "report.txt");
    Map<String, Object> emptyOptions = Map.of();
  ...
  void shouldValidateOptionsForPdfCreateOperation() {
    // Given
    Map<String, Object> validOptionsWithText =
        Map.of(
            ...
            "title", "Test Document",
            "author", "Test Author");
    Map<String, Object> validOptionsWithPages =
        Map.of(
            "pages", "3",
            "page_size", "LETTER");
    Map<String, Object> emptyOptions = Map.of();
    ...
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_CREATE, validOptionsWithPages));
  ...
  void shouldThrowExceptionForPdfCreateWithInvalidInputFiles() {
    ...
    Job jobWithOneFile =
        new Job("job-456", JobOperation.PDF_CREATE, List.of("template.pdf"), Map.of());
  ...
  void shouldThrowExceptionForPdfCompareWithInvalidInputFiles() {
    // Given
    Job jobWithOneFile =
        new Job("job-123", JobOperation.PDF_COMPARE, List.of("file1.pdf"), Map.of());
    Job jobWithThreeFiles =
        new Job(
            "job-456",
            JobOperation.PDF_COMPARE,
            List.of("file1.pdf", "file2.pdf", "file3.pdf"),
            Map.of());

    // When & Then
    IllegalArgumentException exception1 =
        assertThrows(
            IllegalArgumentException.class, () -> pdfProcessingService.processJob(jobWithOneFile));
  ...
  void shouldValidatePdfCompareOptionsWithDetailedDiff() {
    ...
    assertTrue(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_COMPARE, Map.of())); // Empty options should be valid
  ...
  void shouldValidateOptionsForPdfEditOperation() {
    // Given
    Map<String, Object> validOptions =
        Map.of("edit_type", "add_text", "text", "Hello", "x", 100, "y", 200);
  ...
  void shouldValidateOptionsForPdfProtectOperation() {
    // Given
    Map<String, Object> validOptions = Map.of("password", "secret123");
    Map<String, Object> validOptionsWithPermissions =
        Map.of(
            "password", "secret123",
            "allow_printing", true,
            "allow_copying", false);
    ...
    assertTrue(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_PROTECT, validOptionsWithPermissions));
  ...
  void shouldValidateOptionsForPdfSignOperation() {
    ...
    Map<String, Object> validMinimalOptions =
        Map.of(
            "certificate_path", "/path/to/cert.p12",
            "certificate_password", "password123");
    ...
    Map<String, Object> emptyCertPath =
        Map.of(
            "certificate_path", "",
            "certificate_password", "password123");
    Map<String, Object> emptyCertPassword =
        Map.of(
            "certificate_path", "/path/to/cert.p12",
            "certificate_password", "");
    Map<String, Object> longReason =
        Map.of(
            "certificate_path", "/path/to/cert.p12",
            "certificate_password", "password123",
  ...
  void shouldThrowExceptionForPdfEditWithInvalidInputFiles() {
    // Given
    Job jobWithNoFiles =
        new Job("job-123", JobOperation.PDF_EDIT, List.of(), Map.of("editType", "addText"));
    Job jobWithTwoFiles =
        new Job(
            "job-456",
            JobOperation.PDF_EDIT,
            List.of("file1.pdf", "file2.pdf"),
            Map.of("editType", "addText"));

    // When & Then
    IllegalArgumentException exception1 =
        assertThrows(
            IllegalArgumentException.class, () -> pdfProcessingService.processJob(jobWithNoFiles));
    assertEquals("Job input files cannot be empty", exception1.getMessage());

    IllegalArgumentException exception2 =
        assertThrows(
            IllegalArgumentException.class, () -> pdfProcessingService.processJob(jobWithTwoFiles));
  ...
  void shouldThrowExceptionForPdfEditWithMissingEditType() {
    // Given
    Job jobWithoutEditType =
        new Job("job-123", JobOperation.PDF_EDIT, List.of("file1.pdf"), Map.of());
    ...
    assertEquals(
        "Edit type is required (add_text, remove_text, replace_text)", exception.getMessage());
  }
  ...
  void shouldThrowExceptionForPdfProtectWithInvalidInputFiles() {
    // Given
    Job jobWithNoFiles =
        new Job("job-123", JobOperation.PDF_PROTECT, List.of(), Map.of("userPassword", "pass123"));
    Job jobWithTwoFiles =
        new Job(
            "job-456",
            JobOperation.PDF_PROTECT,
            List.of("file1.pdf", "file2.pdf"),
            Map.of("userPassword", "pass123"));
  ...
  void shouldThrowExceptionForPdfProtectWithMissingPasswords() {
    // Given
    Job jobWithoutPasswords =
        new Job("job-123", JobOperation.PDF_PROTECT, List.of("file1.pdf"), Map.of());
  ...
  void shouldThrowExceptionForPdfUnlockWithInvalidInputFiles() {
    // Given
    Job jobWithNoFiles =
        new Job("job-123", JobOperation.PDF_UNLOCK, List.of(), Map.of("password", "pass123"));
    Job jobWithTwoFiles =
        new Job(
            "job-456",
  ...
  void shouldValidateOptionsForPdfOptimizeOperation() {
    ...
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_OPTIMIZE, validOptionsWithNumber));
    assertTrue(pdfProcessingService.validateOptions(JobOperation.PDF_OPTIMIZE, emptyOptions));
    assertFalse(
        pdfProcessingService.validateOptions(JobOperation.PDF_OPTIMIZE, invalidCompressionLevel));
    assertFalse(
        pdfProcessingService.validateOptions(JobOperation.PDF_OPTIMIZE, invalidCompressionNumber));
  }
  ...
  void shouldValidateOptionsForPdfValidateOperation() {
    ...
    assertFalse(
        pdfProcessingService.validateOptions(JobOperation.PDF_VALIDATE, invalidValidationType));
    assertFalse(
        pdfProcessingService.validateOptions(JobOperation.PDF_VALIDATE, invalidComplianceStandard));
  }
  ...
  void shouldReturnOptionsSchemaForNewOperations() {
    ...
    Map<String, Object> protectSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_PROTECT);
    ...
    Map<String, Object> unlockSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_UNLOCK);
    assertNotNull(unlockSchema);
    assertTrue(unlockSchema.containsKey("password"));

    // Test PDF_OPTIMIZE operation schema
    Map<String, Object> optimizeSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_OPTIMIZE);
    ...
    Map<String, Object> validateSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_VALIDATE);
    ...
    Map<String, Object> repairSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_REPAIR);
  ...
  void shouldThrowExceptionForPdfOptimizeWithInvalidInputFiles() {
    ...
    Job jobWithTwoFiles =
        new Job("job-456", JobOperation.PDF_OPTIMIZE, List.of("file1.pdf", "file2.pdf"), Map.of());
  ...
  void shouldThrowExceptionForPdfValidateWithInvalidInputFiles() {
    ...
    Job jobWithTwoFiles =
        new Job("job-456", JobOperation.PDF_VALIDATE, List.of("file1.pdf", "file2.pdf"), Map.of());
  ...
  void shouldThrowExceptionForPdfRepairWithInvalidInputFiles() {
    ...
    Job jobWithTwoFiles =
        new Job("job-456", JobOperation.PDF_REPAIR, List.of("file1.pdf", "file2.pdf"), Map.of());
  ...
  void shouldThrowExceptionForPdfUnlockWithMissingPassword() {
    // Given
    Job jobWithoutPassword =
        new Job("job-123", JobOperation.PDF_UNLOCK, List.of("file1.pdf"), Map.of());
  ...
  void shouldThrowExceptionForPdfEditWithUnsupportedEditType() {
    // Given
    Job jobWithInvalidEditType =
        new Job(
            "job-123",
            JobOperation.PDF_EDIT,
            List.of("file1.pdf"),
            Map.of("edit_type", "invalidType"));

    // When & Then
    RuntimeException exception =
        assertThrows(
            RuntimeException.class, () -> pdfProcessingService.processJob(jobWithInvalidEditType));
    assertTrue(
        exception
            .getMessage()
            .contains(
                "Unsupported edit type: invalidType. Supported types: add_text, remove_text, replace_text"));
  }
  ...
  void shouldThrowExceptionForAddTextWithMissingText() {
    ...
    Job jobWithoutText =
        new Job(
            ...
            JobOperation.PDF_EDIT,
            List.of("file1.pdf"),
            Map.of("edit_type", "add_text"));

    // When & Then
    RuntimeException exception =
        assertThrows(RuntimeException.class, () -> pdfProcessingService.processJob(jobWithoutText));
  ...
  void shouldThrowExceptionForReplaceTextWithMissingNewText() {
    // Given
    Job jobWithoutNewText =
        new Job(
            "job-123",
            JobOperation.PDF_EDIT,
            List.of("file1.pdf"),
            Map.of("edit_type", "replace_text"));

    // When & Then
    RuntimeException exception =
        assertThrows(
            RuntimeException.class, () -> pdfProcessingService.processJob(jobWithoutNewText));
  ...
  void shouldValidateOptionsForPdfExtractResourcesOperation() {
    ...
    // When & Then
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_EXTRACT_RESOURCES, validOptions));
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_EXTRACT_RESOURCES, validOptionsAll));
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_EXTRACT_RESOURCES, emptyOptions));
    assertFalse(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_EXTRACT_RESOURCES, invalidResourceType));
    assertFalse(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_EXTRACT_RESOURCES, invalidImageFormat));
  }
  ...
  void shouldValidateOptionsForPdfRemoveResourcesOperation() {
    ...
    // When & Then
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_REMOVE_RESOURCES, validOptions));
    assertTrue(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_REMOVE_RESOURCES, validOptionsMetadata));
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_REMOVE_RESOURCES, emptyOptions));
    assertFalse(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_REMOVE_RESOURCES, invalidResourceType));
    assertFalse(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_REMOVE_RESOURCES, invalidKeepStructure));
  }
  ...
  void shouldThrowExceptionForPdfExtractResourcesWithInvalidInputFiles() {
    // Given
    Job jobWithNoFiles =
        new Job("job-123", JobOperation.PDF_EXTRACT_RESOURCES, List.of(), Map.of());
    Job jobWithMultipleFiles =
        new Job(
            "job-123",
    ...
    RuntimeException exception1 =
        assertThrows(RuntimeException.class, () -> pdfProcessingService.processJob(jobWithNoFiles));
    assertTrue(
        exception1
            .getMessage()
            .contains("PDF_EXTRACT_RESOURCES operation requires exactly one input file"));

    RuntimeException exception2 =
        assertThrows(
            RuntimeException.class, () -> pdfProcessingService.processJob(jobWithMultipleFiles));
    assertTrue(
        exception2
            .getMessage()
            .contains("PDF_EXTRACT_RESOURCES operation requires exactly one input file"));
  ...
  void shouldThrowExceptionForPdfRemoveResourcesWithInvalidInputFiles() {
    ...
    assertTrue(
        exception1
            .getMessage()
            .contains("PDF_REMOVE_RESOURCES operation requires exactly one input file"));
  ...
  void shouldReturnOptionsSchemaForResourceOperations() {
    ...
    Map<String, Object> extractSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_EXTRACT_RESOURCES);
    Map<String, Object> removeSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_REMOVE_RESOURCES);
  ...
  void shouldValidateOptionsForPdfFromEpubOperation() {
    ...
    Map<String, Object> validOptionsComplete =
        Map.of(
            "preserve_formatting",
            true,
            "include_toc",
    ...
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_FROM_EPUB, validOptionsComplete));
  ...
  void shouldValidateOptionsForPdfFromDjvuOperation() {
    // Given
    Map<String, Object> validOptions =
        Map.of("preserve_quality", true, "compression_level", "medium");
    Map<String, Object> validOptionsComplete =
        Map.of(
            "preserve_quality",
            false,
    ...
    assertTrue(
        pdfProcessingService.validateOptions(JobOperation.PDF_FROM_DJVU, validOptionsComplete));
    assertTrue(pdfProcessingService.validateOptions(JobOperation.PDF_FROM_DJVU, emptyOptions));
    assertFalse(
        pdfProcessingService.validateOptions(JobOperation.PDF_FROM_DJVU, invalidCompression));
  ...
  void shouldReturnOptionsSchemaForAdvancedConversions() {
    // When
    Map<String, Object> pdfASchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_TO_PDFA);
    Map<String, Object> epubSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_FROM_EPUB);
    Map<String, Object> djvuSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_FROM_DJVU);
  ...
  void shouldThrowExceptionForAdvancedConversionsWithInvalidInputFiles() {
    ...
    Job epubJobMultipleFiles =
        new Job(
            "job-456", JobOperation.PDF_FROM_EPUB, List.of("file1.epub", "file2.epub"), Map.of());
    Job djvuJobNoFiles = new Job("job-789", JobOperation.PDF_FROM_DJVU, List.of(), Map.of());

    // When & Then
    RuntimeException exception1 =
        assertThrows(RuntimeException.class, () -> pdfProcessingService.processJob(pdfAJobNoFiles));
    assertTrue(
        exception1.getMessage().contains("PDF_TO_PDFA operation requires exactly one input file"));

    RuntimeException exception2 =
        assertThrows(
            RuntimeException.class, () -> pdfProcessingService.processJob(epubJobMultipleFiles));
    assertTrue(
        exception2
            .getMessage()
            .contains("PDF_FROM_EPUB operation requires exactly one input file"));

    RuntimeException exception3 =
        assertThrows(RuntimeException.class, () -> pdfProcessingService.processJob(djvuJobNoFiles));
    assertTrue(
        exception3
            .getMessage()
            .contains("PDF_FROM_DJVU operation requires exactly one input file"));
  }
  ...
  void shouldValidateOptionsForPdfOcrOperation() {
    ...
    assertTrue(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_OCR, emptyOptions)); // Should use defaults
  }
  ...
  void shouldValidateOptionsForPdfToAudioOperation() {
    ...
    Map<String, Object> validOptions =
        Map.of(
            "voice", "default", "speed", 1.0, "output_format", "mp3", "extract_text_first", true);
    ...
    assertTrue(
        pdfProcessingService.validateOptions(
            JobOperation.PDF_TO_AUDIO, emptyOptions)); // Should use defaults
  }
  ...
  void shouldReturnOptionsSchemaForOcrAndAccessibility() {
    ...
    Map<String, Object> audioSchema =
        pdfProcessingService.getOptionsSchema(JobOperation.PDF_TO_AUDIO);
  ...
  void shouldThrowExceptionForOcrAndAccessibilityWithInvalidInputFiles() {
    ...
    Job audioJobMultipleFiles =
        new Job("job-456", JobOperation.PDF_TO_AUDIO, List.of("file1.pdf", "file2.pdf"), Map.of());

    // When & Then
    RuntimeException exception1 =
        assertThrows(RuntimeException.class, () -> pdfProcessingService.processJob(ocrJobNoFiles));
    assertEquals("Job input files cannot be empty", exception1.getMessage());

    RuntimeException exception2 =
        assertThrows(
            RuntimeException.class, () -> pdfProcessingService.processJob(audioJobMultipleFiles));
