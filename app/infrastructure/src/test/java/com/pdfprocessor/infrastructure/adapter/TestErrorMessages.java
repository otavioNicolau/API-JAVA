...
public class TestErrorMessages {
  public static void main(String[] args) {
    ...
    PdfProcessingServiceImpl service = new PdfProcessingServiceImpl(storageService);
    ...
    Job job1 =
        new Job(
            ...
            List.of("input.pdf"),
            Map.of("edit_type", "add_text", "page", 1));
    ...
    Job job3 =
        new Job(
            ...
            JobOperation.PDF_EDIT,
            List.of("input.pdf"),
            Map.of("edit_type", "replace_text", "old_text", "old"));
