...
public class ApiKeyAuthenticationFilter extends OncePerRequestFilter {
  ...
  protected void doFilterInternal(
    ...
    System.out.println(
        "[FILTER] ApiKeyAuthenticationFilter executado para: " + request.getRequestURI());
    ...
    if (apiKey == null || !isValidApiKey(apiKey)) {
      ...
      response
          .getWriter()
          .write("{\"error\":\"Unauthorized\",\"message\":\"Valid API key required\"}");
      return;
    }
    ...
    try {
      ...
      System.out.println(
          "[DEBUG] SecurityContext após definir: "
